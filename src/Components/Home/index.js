...
import { FormLand, LoadHome, Loader } from 'Components/Shared';
              ...
              <div className={styles.containerSectionHead}>
                <div className={styles.content}>
                  ...
                  <p className={styles.Text}>
                    Mega Rocket web is a monthly management system for members and trainers so that
                    they can dynamically sign up for their activities in the gym
                  </p>
                </div>
